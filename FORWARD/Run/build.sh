...
setenv MY_PROJECT_DIR       ${MY_ROOT_DIR}/KINO/FORWARD
...
# analytical source files, if any. See the templates in User/Functionals.
 ...
 setenv MY_HEADER_DIR       ${MY_PROJECT_DIR}/Compile

 setenv MY_ANALYTICAL_DIR   ${MY_PROJECT_DIR}/Run

# Put the binary to execute in the following directory.

 setenv BINDIR              ${MY_PROJECT_DIR}/Run

# Put the f90 files in a project specific Build directory to avoid conflict
# with other projects.

 setenv SCRATCH_DIR         ${MY_PROJECT_DIR}/Compile/Build
